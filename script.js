...
// Accès au données de l'opah
const lien_data_opah =
  "https://raw.githubusercontent.com/mondarverne/OPAH/main/DATA/data_opah.geojson";

const lien_data_communes_opah =
  "https://raw.githubusercontent.com/mondarverne/OPAH/main/DATA/data_communes_opah.geojson";
...
map.on("load", function () {
  ...
  map.addLayer({
    ...
    // Ajout parcelles concernés par l'OPAH depuis GitHub
    map.addSource('parc_opah', {
      type: 'geojson',
      data: 'https://raw.githubusercontent.com/mondarverne/OPAH/main/DATA/data_opah.geojson'
    });
    ...
    map.addLayer({
      ...
      paint: {
        "fill-color": "#e4146c", //couleur poly
        "fill-opacity": 0.2, // opacite
